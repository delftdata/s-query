...
"""
file_name = 'images/tp_vanilla_squery.pgf'
...
histogram_columns = {}
histogram_columns['S-Query 1M'] = 'benchmarks/nexmark/3-node/1-million/s-query-1M.hgrm'
histogram_columns['S-Query 5M'] = 'benchmarks/nexmark/3-node/5-million/s-query-5M.hgrm'
histogram_columns['S-Query 9M'] = 'benchmarks/nexmark/3-node/9-million/s-query-9M.hgrm'

histogram_columns['\\vanilla[upper] 1M'] = 'benchmarks/nexmark/3-node/1-million/stock-1M.hgrm'
histogram_columns['\\vanilla[upper] 5M'] = 'benchmarks/nexmark/3-node/5-million/stock-5M.hgrm'
histogram_columns['\\vanilla[upper] 9M'] = 'benchmarks/nexmark/3-node/9-million/stock-9M.hgrm'
...
label_line['S-Query 1M'] = ('>', '-', 'g')
label_line['S-Query 5M'] = ('v', '-', 'r')
label_line['S-Query 9M'] = ('^', '-', 'b')

label_line['\\vanilla[upper] 1M'] = ('x', '-.', 'g')
label_line['\\vanilla[upper] 5M'] = ('.', '-.', 'r')
label_line['\\vanilla[upper] 9M'] = ('s', '-.', 'b')
